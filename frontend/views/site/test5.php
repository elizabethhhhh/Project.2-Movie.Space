...
$sql="SELECT * FROM tickets WHERE customer='Alex'";
...
<?php foreach($tickets as $ticket): ?>
    <table>
<tr><th>&nbsp &nbsp Name &nbsp |</th><th>Row &nbsp |</th><th>Place &nbsp |</th><th>Price &nbsp &nbsp |</th><th>Time &nbsp &nbsp |</th><th>Movie &nbsp</th></tr>

    <tr><td>&nbsp &nbsp &nbsp &nbsp<?php echo htmlspecialchars($ticket['customer']); ?>&nbsp &nbsp &nbsp &nbsp &nbsp|</td>
...
<center><a  class="glow-button15" href="http://dip11/frontend/web/">Total amount ❯ 270 ₴</a><center>
