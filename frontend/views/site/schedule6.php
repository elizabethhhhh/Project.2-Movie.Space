...
<body>
	...
	<div class="block-left">
    	    <img src="images/6film.jpg" width="170" class="leftimg"><p class="tab"></p>
    	    <h3>Raya</h3><p class="tab"></p>
    	    <h5>7.3/10 <img src="images/heart.png" width="30" ></h5>
...
<div class="block-right">
 ...
 <div id="output"></div>
    ...
    <p>
        <center><a id="buy-btn" class="glow-button" href="http://dip11/frontend/web/acount">Buy tickets here ❯<span>0</span></a><center>
    </p>
</div>
