...
<body>
  ...
  <div class="block-left">
          <img src="images/1film.jpg" width="170" class="leftimg"><p class="tab"></p>
          <h3>Red Notice</h3><p class="tab"></p>
          <h5>6.5/10 <img src="images/heart.png" width="30" ></h5>
          <div class="p1">Technology</div> 
          <p>CINETECH+</p>
          <div class="p1">Duration</div>
          <p>117 min.</p>
          <div class="p1">Age Limit</div>
          <p>13+</p>
          <p class="tab"></p>
...
<div class="block-right">
    <svg width="580" height="450" xmlns="http://www.w3.org/2000/svg" id="hall">
      ...
      <g id="places">
        ...
        <use xlink:href="#place" y="398" x="501" data-row="9" data-place="13" data-price="170" fill="#737373"/>
          ...
          <rect stroke="#000" rx="4" id="svg_136" height="17" width="22" y="25.05729" x="165" fill-opacity="null" stroke-opacity="null" stroke-width="0" fill="#969696"/>
          <rect stroke="#000" rx="4" id="svg_137" height="17" width="22" y="25.05729" x="261" fill-opacity="null" stroke-opacity="null" stroke-width="0" fill="#858585"/>
          <rect rx="4" id="svg_138" height="17" width="22" y="24.05729" x="357" stroke-opacity="null" stroke-width="0" fill="#737373" stroke="#000"/>
          <text font-weight="bold" xml:space="preserve" text-anchor="start" font-family="'Palatino Linotype', 'Book Antiqua', Palatino, serif" font-size="16" id="svg_139" y="39.55729" x="198" fill-opacity="null" stroke-opacity="null" stroke-width="0" stroke="#000" fill="#000000">80 ₴</text>
          <text font-weight="bold" xml:space="preserve" text-anchor="start" font-family="'Palatino Linotype', 'Book Antiqua', Palatino, serif" font-size="16" id="svg_140" y="38.55729" x="294" fill-opacity="null" stroke-opacity="null" stroke-width="0" stroke="#000" fill="#000000">90 ₴</text>
          <text font-weight="bold" xml:space="preserve" text-anchor="start" font-family="'Palatino Linotype', 'Book Antiqua', Palatino, serif" font-size="16" id="svg_141" y="38.55729" x="390" fill-opacity="null" stroke-opacity="null" stroke-width="0" stroke="#000" fill="#000000">160 ₴</text>
      </g>
    </svg>
 ...
 <div id="output"></div>
    ...
    <p>
        <center><a id="buy-btn" class="glow-button" href="http://frontend/pagе">Buy tickets here<span>0</span></a><center>
    </p>
</div>


<style>
    .block-left{width:45%;height:740px;overflow:auto;float:left;}
    .block-right{width:55%;height:740px;overflow:auto;}
    .p1{
        line-height: 0.8;
        color: #878787;
    }
